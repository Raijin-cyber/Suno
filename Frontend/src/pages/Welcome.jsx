    ...
    return (
        <main className="flex flex-col items-center justify-center gap-y-10 h-screen">
            ...
            <div className="flex flex-col gap-y-2">
                <Link to={`${status ? "/home" : "/auth"}`} className="bg-[#ec6340] text-white font-semibold font-serif py-2 px-5 lg:py-3 lg:px-8 rounded-xl active:scale-[0.9] transition duration-75">{`${status ? "Home" : "Login"}`}</Link>
